...
static int8_t EmbeddedProject3_Init     (void);
static int8_t EmbeddedProject3_DeInit   (void);
static int8_t EmbeddedProject3_Control  (uint8_t cmd, uint8_t* pbuf, uint16_t length);
static int8_t EmbeddedProject3_Receive  (uint8_t* pbuf, uint32_t *Len);

USBD_CDC_ItfTypeDef USBD_CDC_EmbeddedProject3_fops = 
{
  EmbeddedProject3_Init,
  EmbeddedProject3_DeInit,
  EmbeddedProject3_Control,
  EmbeddedProject3_Receive
};
...
/**
  * @brief  EmbeddedProject3_Control
...
/**
  * @brief  EmbeddedProject3_Receive
  ...
  * @retval Result of the operation: USBD_OK if all operations are OK else USBD_FAIL
  */
static int8_t EmbeddedProject3_Receive(uint8_t* Buf, uint32_t *Len)
{
